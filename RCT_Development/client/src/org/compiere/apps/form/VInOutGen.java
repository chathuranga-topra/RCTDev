...
public class VInOutGen extends InOutGen implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	public void dynInit() throws Exception
	{
		...
		jbuddhiText = new VString("POReference", true, false, true, 10, 15, "", null);
		
		jbuddhiText.addActionListener(this);
		jbuddhiText.setActionCommand("CUSDECK");
		
		jbuddhiText.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent arg0) {
				...
				setPoReference(jbuddhiText.getValue().toString().toUpperCase());
				executeQuery();
