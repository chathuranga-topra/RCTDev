...
public class InOutGen extends GenForm
{
	...
	public Object 			poReference = null;
	...
	public void configureMiniTable(IMiniTable miniTable)
	{
		...
		miniTable.addColumn("M_PriceList_ID");
		...
		String B2="Container Size";
		String C="RCT Arrival Date";
		String D="Name of the Consignee";
		//String E="Container Size";
		String E="Reference Number";
		...
		miniTable.setColumnClass(5, Timestamp.class, true, C);
		miniTable.setColumnClass(6, String.class, true, E);
	...
	//  Create SQL
        StringBuffer sql = new StringBuffer(
            "SELECT DISTINCT ic.C_Order_ID, ic.poreference, ic.description, ic.DocumentNo, bp.Name, ic.DateOrdered, ic.TotalLines, o.Name , pl.name as \"Size\""
            + " FROM M_InOut_Candidate_v ic, AD_Org o, C_BPartner bp, C_DocType dt, c_order c , m_pricelist pl "
            + " WHERE ic.AD_Org_ID=o.AD_Org_ID "
            + " AND ic.C_Order_ID = c.C_Order_ID "
            + " AND pl.m_pricelist_id = c.m_pricelist_id"
            + " AND ic.C_BPartner_ID=bp.C_BPartner_ID"
            + " AND ic.C_DocType_ID=dt.C_DocType_ID"
            + " AND ic.AD_Client_ID=?");

        if (poReference != null)
        	sql.append(" AND ic.poreference like'").append(poReference+"%'");
	...
	public void executeQuery(KeyNamePair docTypeKNPair, IMiniTable miniTable)
	{
		...
		try
		{
			...
			{	
				...
				miniTable.setValueAt(rs.getString(4), row, 6);              //  size
				miniTable.setValueAt(rs.getString(5), row, 4);              //  BPartner
				miniTable.setValueAt(rs.getTimestamp(6), row, 5);
				miniTable.setValueAt(rs.getString(9), row, 3); // Doc No
