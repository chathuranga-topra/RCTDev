...
public class TpUtility {
	...
	//Mounting Demounting and storaage
	private int mountDemount = 1000880;
	
	private int sealNumber = 1004044;
	
	private int taxInvoicePrintFormat = 1000037;//1000688//1000037
	
	private int cashierRole = 1000014;
	
	private int cusReleasePrintFormat = 1000109;
	
	private int docTypeParkingPostGatePass = 1000061;
	
	//Parking - Late Gate Pass M_Product_ID
	private int parkingLateGatePass = 1004051;
	
	public int getParkingLateGatePass() {
		return parkingLateGatePass;
	}
	
	public int getDocTypeParkingPostGatePass() {
		return docTypeParkingPostGatePass;
	}
